...
export function LinkCardComponent(properties) {
    if (!properties.url)
        return h("div", { class: "hidden" }, 'Invalid URL. ("url" attribute is required)');
    ...
    const nDescription = description ? h("div", { class: "lc-description" }, description) : null;
    ...
    const nImage = image ? h("div", { class: "lc-image", style: `background-image: url(${image})` }) : null;
