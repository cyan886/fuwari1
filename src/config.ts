...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		...
		{
			src: "https://r2.xuan.love/%E5%A4%B4%E5%83%8F/mmexport1769137328632.jpeg", // Path of the favicon, relative to the /public directory
...
export const antiLeechConfig: AntiLeechConfig = {
	enable: true,
	officialSites: [{ url: "https://xhihi.com", name: "主站" }],
	debug: false,
